use crate::{
    ...
    Context, Properties, Readable, TResult, Writable,
};
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V>
    for PalMapObjectCharacterTeamMissionModel
{
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectCharacterTeamMissionModel {
            mission_id: crate::read_string(reader)?,
            state: reader.read_u8()?,
            start_time: reader.read_i64::<LE>()?,
            unknown_bytes: {
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectCharacterTeamMissionModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        crate::write_string(writer, &self.mission_id)?;
        writer.write_u8(self.state)?;
        writer.write_i64::<LE>(self.start_time)?;
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectFarmSkillFruitsModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectFarmSkillFruitsModel {
            ...
            skill_fruits_id: crate::read_string(reader)?,
            current_state: reader.read_u8()?,
            progress_rate: reader.read_f32::<LE>()?,
            trailing_bytes: {
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectFarmSkillFruitsModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        crate::write_string(writer, &self.skill_fruits_id)?;
        writer.write_u8(self.current_state)?;
        writer.write_f32::<LE>(self.progress_rate)?;
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectSupplyStorageModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectSupplyStorageModel {
            created_at_real_time: reader.read_i64::<LE>()?,
            trailing_bytes: {
                let mut bytes = [0u8; 8];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectSupplyStorageModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_i64::<LE>(self.created_at_real_time)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
pub struct PalMapObjectItemBoothTradeInfo {
    ...
    pub seller_player_uid: uuid::Uuid,
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectItemBoothTradeInfo {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectItemBoothTradeInfo {
            product: PalItemAndNum::read(reader)?,
            cost: PalItemAndNum::read(reader)?,
            seller_player_uid: uuid::Uuid::read(reader)?,
        })
    }
}

impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectItemBoothTradeInfo {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        self.product.write(writer)?;
        self.cost.write(writer)?;
        self.seller_player_uid.write(writer)?;
        Ok(())
    }
}
...
pub struct PalMapObjectItemBoothModel {
    pub leading_bytes: [u8; 4],
    pub private_lock_player_uid: uuid::Uuid,
    pub trade_infos: Vec<PalMapObjectItemBoothTradeInfo>,
    pub trailing_bytes: [u8; 20],
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectItemBoothModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        let leading_bytes = {
            let mut bytes = [0u8; 4];
            reader.read_exact(&mut bytes)?;
        ...
        let private_lock_player_uid = uuid::Uuid::read(reader)?;
        let trade_infos_count = reader.read_u32::<LE>()?;
        let trade_infos = crate::read_array(
            trade_infos_count,
            reader,
            PalMapObjectItemBoothTradeInfo::read,
        )?;
        let trailing_bytes = {
            let mut bytes = [0u8; 20];
            reader.read_exact(&mut bytes)?;
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectItemBoothModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        self.private_lock_player_uid.write(writer)?;
        writer.write_u32::<LE>(self.trade_infos.len() as u32)?;
        for trade_info in &self.trade_infos {
            trade_info.write(writer)?;
        }
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectEnergyStorageModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectEnergyStorageModel {
            stored_energy_amount: reader.read_f32::<LE>()?,
            trailing_bytes: {
                let mut bytes = [0u8; 8];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectEnergyStorageModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_f32::<LE>(self.stored_energy_amount)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
pub struct PalMapObjectDeathDroppedCharacterModel {
    pub stored_parameter_id: uuid::Uuid,
    pub owner_player_uid: uuid::Uuid,
    pub trailing_bytes: Vec<u8>,
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V>
    for PalMapObjectDeathDroppedCharacterModel
{
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectDeathDroppedCharacterModel {
            stored_parameter_id: uuid::Uuid::read(reader)?,
            owner_player_uid: uuid::Uuid::read(reader)?,
            trailing_bytes: {
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectDeathDroppedCharacterModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        self.stored_parameter_id.write(writer)?;
        self.owner_player_uid.write(writer)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectConvertItemModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectConvertItemModel {
            ...
            current_recipe_id: crate::read_string(reader)?,
            requested_product_num: reader.read_i32::<LE>()?,
            remain_product_num: reader.read_i32::<LE>()?,
            work_speed_additional_rate: reader.read_f32::<LE>()?,
            trailing_bytes: {
                let mut bytes = [0u8; 8];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectConvertItemModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        crate::write_string(writer, &self.current_recipe_id)?;
        writer.write_i32::<LE>(self.requested_product_num)?;
        writer.write_i32::<LE>(self.remain_product_num)?;
        writer.write_f32::<LE>(self.work_speed_additional_rate)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectPickupItemOnLevelModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectPickupItemOnLevelModel {
            auto_picked_up: reader.read_u32::<LE>()? > 0,
        })
    }
}

impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectPickupItemOnLevelModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_u32::<LE>(if self.auto_picked_up { 1 } else { 0 })?;
        Ok(())
    }
}
...
pub struct PalMapObjectDropItemModel {
    pub auto_picked_up: bool,
    pub pickupable_player_uid: uuid::Uuid,
    pub remove_pickup_guard_timer_handle: i64,
    pub item_id: PalItemId,
    pub trailing_bytes: [u8; 4],
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectDropItemModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectDropItemModel {
            auto_picked_up: reader.read_u32::<LE>()? > 0,
            pickupable_player_uid: uuid::Uuid::read(reader)?,
            remove_pickup_guard_timer_handle: reader.read_i64::<LE>()?,
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectDropItemModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_u32::<LE>(if self.auto_picked_up { 1 } else { 0 })?;
        self.pickupable_player_uid.write(writer)?;
        writer.write_i64::<LE>(self.remove_pickup_guard_timer_handle)?;
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectItemDropOnDamagModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        let drop_item_count = reader.read_u32::<LE>()?;
        let drop_item_infos = crate::read_array(drop_item_count, reader, PalItemAndNum::read)?;
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectItemDropOnDamagModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_u32::<LE>(self.drop_item_infos.len() as u32)?;
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V>
    for PalMapObjectDeathPenaltyStorageModel
{
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        let auto_destroy_if_empty = reader.read_u32::<LE>()? > 0;
        let owner_player_uid = uuid::Uuid::read(reader)?;
        let created_at = reader.read_i64::<LE>()?;
        let mut trailing_bytes = Vec::new();
        reader.read_to_end(&mut trailing_bytes)?;
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectDeathPenaltyStorageModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_u32::<LE>(if self.auto_destroy_if_empty { 1 } else { 0 })?;
        self.owner_player_uid.write(writer)?;
        writer.write_i64::<LE>(self.created_at)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V>
    for PalMapObjectDefenseBulletLauncherModel
{
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectDefenseBulletLauncherModel {
            ...
            remaining_bullets: reader.read_i32::<LE>()?,
            magazine_size: reader.read_i32::<LE>()?,
            bullet_item_name: crate::read_string(reader)?,
            trailing_bytes: {
                let mut bytes = [0u8; 4];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectDefenseBulletLauncherModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        writer.write_i32::<LE>(self.remaining_bullets)?;
        writer.write_i32::<LE>(self.magazine_size)?;
        crate::write_string(writer, &self.bullet_item_name)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectGenerateEnergyModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectGenerateEnergyModel {
            generate_energy_rate_by_worker: reader.read_f32::<LE>()?,
            stored_energy_amount: reader.read_f32::<LE>()?,
            consume_energy_amount: reader.read_f32::<LE>()?,
        })
    }
}

impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectGenerateEnergyModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_f32::<LE>(self.generate_energy_rate_by_worker)?;
        writer.write_f32::<LE>(self.stored_energy_amount)?;
        writer.write_f32::<LE>(self.consume_energy_amount)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V>
    for PalMapObjectFarmBlockV2ModelStateMachine
{
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectFarmBlockV2ModelStateMachine {
            growup_required_time: reader.read_f32::<LE>()?,
            growup_progress_time: reader.read_f32::<LE>()?,
        })
    }
}

impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectFarmBlockV2ModelStateMachine {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_f32::<LE>(self.growup_required_time)?;
        writer.write_f32::<LE>(self.growup_progress_time)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectFarmBlockV2Model {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectFarmBlockV2Model {
            crop_progress_rate: reader.read_f32::<LE>()?,
            crop_data_id: crate::read_string(reader)?,
            current_state: reader.read_u8()?,
            crop_progress_rate_value: reader.read_f32::<LE>()?,
            water_stack_rate_value: reader.read_f32::<LE>()?,
            state_machine: PalMapObjectFarmBlockV2ModelStateMachine::read(reader)?,
            trailing_bytes: {
                let mut bytes = [0u8; 8];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectFarmBlockV2Model {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_f32::<LE>(self.crop_progress_rate)?;
        crate::write_string(writer, &self.crop_data_id)?;
        writer.write_u8(self.current_state)?;
        writer.write_f32::<LE>(self.crop_progress_rate_value)?;
        writer.write_f32::<LE>(self.water_stack_rate_value)?;
        self.state_machine.write(writer)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
pub struct PalMapObjectFastTravelPointModel {
    pub location_instance_id: uuid::Uuid,
    pub trailing_bytes: Vec<u8>,
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectFastTravelPointModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        let location_instance_id = uuid::Uuid::read(reader)?;
        let mut trailing_bytes = Vec::new();
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectFastTravelPointModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        self.location_instance_id.write(writer)?;
...
fn read_int_array<R: Read + Seek, V: crate::VersionInfo>(
    count: u32,
    reader: &mut Context<R, V>,
) -> TResult<Vec<i32>> {
    let mut vec = Vec::with_capacity(count as usize);
    for _ in 0..count {
        vec.push(reader.read_i32::<LE>()?);
    }
    Ok(vec)
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectShippingItemModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        let count = reader.read_u32::<LE>()?;
        Ok(PalMapObjectShippingItemModel {
            shipping_hours: read_int_array(count, reader)?,
        })
    }
}

impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectShippingItemModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_u32::<LE>(self.shipping_hours.len() as u32)?;
        for hour in &self.shipping_hours {
            writer.write_i32::<LE>(*hour)?;
        }
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectProductItemModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectProductItemModel {
            ...
            work_speed_additional_rate: reader.read_f32::<LE>()?,
            product_item_id: crate::read_string(reader)?,
            trailing_bytes: {
                let mut bytes = [0u8; 4];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectProductItemModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        writer.write_f32::<LE>(self.work_speed_additional_rate)?;
        crate::write_string(writer, &self.product_item_id)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectRecoverOtomoModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectRecoverOtomoModel {
            recover_amount_by_sec: reader.read_f32::<LE>()?,
        })
    }
}

impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectRecoverOtomoModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_f32::<LE>(self.recover_amount_by_sec)?;
        Ok(())
    }
}

#[derive(Debug, PartialEq, Serialize, Deserialize)]
pub struct PalMapObjectHatchingEggModel {
    pub leading_bytes: [u8; 4],
    pub hatched_character_save_parameter: Properties,
    pub current_pal_egg_temp_diff: i32,
    pub hatched_character_guid: uuid::Uuid,
    pub trailing_bytes: [u8; 4],
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectHatchingEggModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectHatchingEggModel {
            ...
            hatched_character_save_parameter: crate::read_properties_until_none(reader)?,
            current_pal_egg_temp_diff: reader.read_i32::<LE>()?,
            hatched_character_guid: uuid::Uuid::read(reader)?,
            trailing_bytes: {
                let mut bytes = [0u8; 4];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectHatchingEggModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        crate::write_properties_none_terminated(writer, &self.hatched_character_save_parameter)?;
        writer.write_i32::<LE>(self.current_pal_egg_temp_diff)?;
        self.hatched_character_guid.write(writer)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectTreasureBoxModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectTreasureBoxModel {
            treasure_grade_type: reader.read_u8()?,
            treasure_special_type: reader.read_u8()?,
            opened: reader.read_u8()?,
            long_hold_interaction_duration: reader.read_f32::<LE>()?,
            interact_player_action_type: reader.read_u8()?,
            is_lock_riding: reader.read_u8()?,
        })
    }
}

impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectTreasureBoxModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_u8(self.treasure_grade_type)?;
        writer.write_u8(self.treasure_special_type)?;
        writer.write_u8(self.opened)?;
        writer.write_f32::<LE>(self.long_hold_interaction_duration)?;
        writer.write_u8(self.interact_player_action_type)?;
        writer.write_u8(self.is_lock_riding)?;
        Ok(())
    }
}
...
pub struct PalMapObjectBreedFarmModel {
    pub leading_bytes: [u8; 4],
    pub spawned_egg_instance_ids: Vec<uuid::Uuid>,
    pub trailing_bytes: [u8; 4],
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectBreedFarmModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        let leading_bytes = {
            let mut bytes = [0u8; 4];
            reader.read_exact(&mut bytes)?;
        ...
        let egg_count = reader.read_u32::<LE>()?;
        let spawned_egg_instance_ids = crate::read_array(egg_count, reader, uuid::Uuid::read)?;
        let trailing_bytes = {
            let mut bytes = [0u8; 4];
            reader.read_exact(&mut bytes)?;
            bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectBreedFarmModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        writer.write_u32::<LE>(self.spawned_egg_instance_ids.len() as u32)?;
...
pub struct PalMapObjectSignboardModel {
    ...
    pub last_modified_player_uid: uuid::Uuid,
    pub trailing_bytes: [u8; 4],
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectSignboardModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectSignboardModel {
            ...
            signboard_text: crate::read_string(reader)?,
            last_modified_player_uid: uuid::Uuid::read(reader)?,
            trailing_bytes: {
                let mut bytes = [0u8; 4];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectSignboardModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        crate::write_string(writer, &self.signboard_text)?;
        self.last_modified_player_uid.write(writer)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectTorchModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectTorchModel {
            ignition_minutes: reader.read_i32::<LE>()?,
            extinction_date_time: reader.read_i64::<LE>()?,
            trailing_bytes: {
                let mut bytes = [0u8; 4];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectTorchModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_i32::<LE>(self.ignition_minutes)?;
        writer.write_i64::<LE>(self.extinction_date_time)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
pub struct PalMapObjectPalEggModel {
    pub auto_picked_up: bool,
    pub pickupdable_player_uid: uuid::Uuid,
    pub remove_pickup_guard_timer_handle: i64,
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectPalEggModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectPalEggModel {
            auto_picked_up: reader.read_u32::<LE>()? > 0,
            pickupdable_player_uid: uuid::Uuid::read(reader)?,
            remove_pickup_guard_timer_handle: reader.read_i64::<LE>()?,
        })
    }
}

impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectPalEggModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_u32::<LE>(if self.auto_picked_up { 1 } else { 0 })?;
        self.pickupdable_player_uid.write(writer)?;
        writer.write_i64::<LE>(self.remove_pickup_guard_timer_handle)?;
        Ok(())
    }
}
...
pub struct PalMapObjectBaseCampPoint {
    pub leading_bytes: [u8; 4],
    pub base_camp_id: uuid::Uuid,
    pub trailing_bytes: [u8; 4],
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectBaseCampPoint {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectBaseCampPoint {
            ...
            base_camp_id: uuid::Uuid::read(reader)?,
            trailing_bytes: {
                let mut bytes = [0u8; 4];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectBaseCampPoint {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        self.base_camp_id.write(writer)?;
        writer.write_all(&self.trailing_bytes)?;
        Ok(())
    }
}
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapObjectItemChestModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        Ok(PalMapObjectItemChestModel {
            ...
            private_lock_player_uid: uuid::Uuid::read(reader)?,
            trailing_bytes: {
                let mut bytes = [0u8; 4];
                reader.read_exact(&mut bytes)?;
                bytes
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectItemChestModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        self.private_lock_player_uid.write(writer)?;
        writer.write_all(&self.trailing_bytes)?;
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V>
    for PalMapObjectItemChestAffectCorruption
{
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapObjectItemChestAffectCorruption {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        writer.write_all(&self.leading_bytes)?;
        self.private_lock_player_uid.write(writer)?;
        writer.write_all(&self.trailing_bytes)?;
...
impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for BaseModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        let mut trailing_bytes = Vec::new();
        reader.read_to_end(&mut trailing_bytes)?;
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for BaseModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        if self.trailing_bytes.len() > 0 {
            writer.write_all(&self.trailing_bytes)?;
        }
...
static DEFAULT_UNKNOWN_PAL_MAP_OBJECT_CONCRETE_MODEL_BASE: Lazy<
...
static PAL_BUILD_OBJECT: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
...
static PAL_BUILD_OBJECT_BREED_FARM: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
    m.insert("enemycamp_breedfarm", "PalBuildObjectBreedFarm");
    m
});

static PAL_BUILD_OBJECT_CONVERT_CHARACTER_TO_ITEM: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
        m.insert(
            "dismantlingconveyor",
...
static PAL_BUILD_OBJECT_MONSTER_FARM: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
    m.insert("enemycamp_monsterfarm", "PalBuildObjectMonsterFarm");
    m
});

static PAL_BUILD_OBJECT_RAID_BOSS_SUMMON: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_AMUSEMENT_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_BASE_CAMP_ITEM_DISPENSER_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
        m.insert(
...
static PAL_MAP_OBJECT_BASE_CAMP_PASSIVE_EFFECT_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_BASE_CAMP_PASSIVE_WORK_HARD_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
        m.insert(
            "basecampworkhard",
...
static PAL_MAP_OBJECT_BASE_CAMP_POINT: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_BASE_CAMP_WORKER_DIRECTOR_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
        m.insert(
...
static PAL_MAP_OBJECT_BASE_CAMP_WORKER_EXTRA_STATION_MODEL: Lazy<
    HashMap<&'static str, &'static str>,
> = Lazy::new(|| {
    let mut m = HashMap::new();
    m.insert(
...
static PAL_MAP_OBJECT_BREED_FARM_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_CHARACTER_MAKE_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_CHARACTER_STATUS_OPERATOR_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
        m.insert(
...
static PAL_MAP_OBJECT_CHARACTER_TEAM_MISSION_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_CONVERT_ITEM_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_DAMAGED_SCARECROW_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_DEATH_DROPPED_CHARACTER_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_DEATH_PENALTY_STORAGE_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_DEFENSE_BULLET_LAUNCHER_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_DEFENSE_WAIT_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_DIMENSION_PAL_STORAGE_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
        m.insert(
            "dimensionpalstorage",
...
static PAL_MAP_OBJECT_DISPLAY_CHARACTER_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_DOOR_MODEL: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_DROP_ITEM_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_ENERGY_STORAGE_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_FARM_BLOCK_V2_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_FARM_SKILL_FRUITS_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_FAST_TRAVEL_POINT_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_FISH_POND_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_GENERATE_ENERGY_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_GLOBAL_PAL_STORAGE_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_GUILD_CHEST_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_HATCHING_EGG_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_HEAT_SOURCE_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_INSTANT_EFFECT_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_ITEM_BOOTH_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_ITEM_CHEST_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_ITEM_CHEST_AFFECT_CORRUPTION: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_ITEM_DROP_ON_DAMAG_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_LAB_MODEL: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
    m.insert("lab", "PalMapObjectLabModel");
    m
});

static PAL_MAP_OBJECT_LAMP_MODEL: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_MEDICAL_PAL_BED_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_MONSTER_FARM_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_MULTI_HATCHING_EGG_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
        m.insert(
...
static PAL_MAP_OBJECT_OPERATING_TABLE_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_PAL_BOOTH_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_PAL_EGG_MODEL: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_PAL_FOOD_BOX_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_PAL_MEDICINE_BOX_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_PICKUP_ITEM_ON_LEVEL_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_PLAYER_BED_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_PLAYER_SIT_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_PRODUCT_ITEM_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_RANK_UP_CHARACTER_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_RECOVER_OTOMO_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_REPAIR_ITEM_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_SHIPPING_ITEM_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_SIGNBOARD_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_SKIN_CHANGE_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_SUPPLY_STORAGE_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_TORCH_MODEL: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
...
static PAL_MAP_OBJECT_TREASURE_BOX_MODEL: Lazy<HashMap<&'static str, &'static str>> =
    Lazy::new(|| {
        let mut m = HashMap::new();
...
static MAP_OBJECT_TO_CONCRETE_MODEL: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
    m.extend(
...
#[derive(Debug, PartialEq, Serialize, Deserialize)]
pub enum PalMapConcreteModelVariant {
    ...
    HatchingEgg(PalMapObjectHatchingEggModel),
...
#[derive(Debug, PartialEq, Serialize, Deserialize)]
pub struct PalMapConcreteModel {
    pub instance_id: uuid::Uuid,
    pub model_instance_id: uuid::Uuid,
    pub concrete_model_type: String,
    pub model_data: PalMapConcreteModelVariant,
}

impl<R: Read + Seek, V: crate::VersionInfo> Readable<R, V> for PalMapConcreteModel {
    fn read(reader: &mut Context<R, V>) -> TResult<Self> {
        eprintln!(
            "Warning: PalMapConcreteModel::read called without object_id context, using fallback"
        );
        Self::read_with_object_id(reader, "unknown")
    }
}

impl PalMapConcreteModel {
    pub(crate) fn read_with_object_id<R: Read + Seek, V: crate::VersionInfo>(
        reader: &mut Context<R, V>,
        object_id: &str,
    ) -> TResult<Self> {
        let instance_id = uuid::Uuid::read(reader)?;
        let model_instance_id = uuid::Uuid::read(reader)?;
        ...
        let model_data = match concrete_model_type.as_str() {
            "PalMapObjectCharacterTeamMissionModel" => {
                PalMapConcreteModelVariant::CharacterTeamMission(
                    PalMapObjectCharacterTeamMissionModel::read(reader)?,
                )
            }
            "PalMapObjectFarmSkillFruitsModel" => PalMapConcreteModelVariant::FarmSkillFruits(
                PalMapObjectFarmSkillFruitsModel::read(reader)?,
            ),
            "PalMapObjectSupplyStorageModel" => PalMapConcreteModelVariant::SupplyStorage(
                PalMapObjectSupplyStorageModel::read(reader)?,
            ),
            "PalMapObjectItemBoothModel" => {
                PalMapConcreteModelVariant::ItemBooth(PalMapObjectItemBoothModel::read(reader)?)
            }
            "PalMapObjectEnergyStorageModel" => PalMapConcreteModelVariant::EnergyStorage(
                PalMapObjectEnergyStorageModel::read(reader)?,
            ),
            "PalMapObjectDeathDroppedCharacterModel" => {
                PalMapConcreteModelVariant::DeathDroppedCharacter(
                    PalMapObjectDeathDroppedCharacterModel::read(reader)?,
                )
            }
            "PalMapObjectConvertItemModel" => {
                PalMapConcreteModelVariant::ConvertItem(PalMapObjectConvertItemModel::read(reader)?)
            }
            "PalMapObjectPickupItemOnLevelModel" => PalMapConcreteModelVariant::PickupItemOnLevel(
                PalMapObjectPickupItemOnLevelModel::read(reader)?,
            ),
            "PalMapObjectDropItemModel" => {
                PalMapConcreteModelVariant::DropItem(PalMapObjectDropItemModel::read(reader)?)
            }
            "PalMapObjectItemDropOnDamagModel" => PalMapConcreteModelVariant::ItemDropOnDamag(
                PalMapObjectItemDropOnDamagModel::read(reader)?,
            ),
            "PalMapObjectDeathPenaltyStorageModel" => {
                PalMapConcreteModelVariant::DeathPenaltyStorage(
                    PalMapObjectDeathPenaltyStorageModel::read(reader)?,
                )
            }
            "PalMapObjectDefenseBulletLauncherModel" => {
                PalMapConcreteModelVariant::DefenseBulletLauncher(
                    PalMapObjectDefenseBulletLauncherModel::read(reader)?,
                )
            }
            "PalMapObjectGenerateEnergyModel" => PalMapConcreteModelVariant::GenerateEnergy(
                PalMapObjectGenerateEnergyModel::read(reader)?,
            ),
            "PalMapObjectFarmBlockV2Model" => {
                PalMapConcreteModelVariant::FarmBlockV2(PalMapObjectFarmBlockV2Model::read(reader)?)
            }
            "PalMapObjectFastTravelPointModel" => PalMapConcreteModelVariant::FastTravelPoint(
                PalMapObjectFastTravelPointModel::read(reader)?,
            ),
            "PalMapObjectShippingItemModel" => PalMapConcreteModelVariant::ShippingItem(
                PalMapObjectShippingItemModel::read(reader)?,
            ),
            "PalMapObjectProductItemModel" => {
                PalMapConcreteModelVariant::ProductItem(PalMapObjectProductItemModel::read(reader)?)
            }
            "PalMapObjectRecoverOtomoModel" => PalMapConcreteModelVariant::RecoverOtomo(
                PalMapObjectRecoverOtomoModel::read(reader)?,
            ),
            "PalMapObjectHatchingEggModel" => {
                PalMapConcreteModelVariant::HatchingEgg(PalMapObjectHatchingEggModel::read(reader)?)
            }
            "PalMapObjectTreasureBoxModel" => {
                PalMapConcreteModelVariant::TreasureBox(PalMapObjectTreasureBoxModel::read(reader)?)
            }
            "PalMapObjectBreedFarmModel" => {
                PalMapConcreteModelVariant::BreedFarm(PalMapObjectBreedFarmModel::read(reader)?)
            }
            "PalMapObjectSignboardModel" => {
                PalMapConcreteModelVariant::Signboard(PalMapObjectSignboardModel::read(reader)?)
            }
            "PalMapObjectTorchModel" => {
                PalMapConcreteModelVariant::Torch(PalMapObjectTorchModel::read(reader)?)
            }
            "PalMapObjectPalEggModel" => {
                PalMapConcreteModelVariant::PalEgg(PalMapObjectPalEggModel::read(reader)?)
            }
            "PalMapObjectBaseCampPoint" => {
                PalMapConcreteModelVariant::BaseCampPoint(PalMapObjectBaseCampPoint::read(reader)?)
            }
            "PalMapObjectItemChestModel" => {
                PalMapConcreteModelVariant::ItemChest(PalMapObjectItemChestModel::read(reader)?)
            }
            "PalMapObjectItemChest_AffectCorruption" => {
                PalMapConcreteModelVariant::ItemChestAffectCorruption(
                    PalMapObjectItemChestAffectCorruption::read(reader)?,
                )
            }
            _ => PalMapConcreteModelVariant::Unknown(BaseModel::read(reader)?),
        };
...
impl<W: Write, V: crate::VersionInfo> Writable<W, V> for PalMapConcreteModel {
    fn write(&self, writer: &mut Context<W, V>) -> TResult<()> {
        self.instance_id.write(writer)?;
        self.model_instance_id.write(writer)?;

        match &self.model_data {
            PalMapConcreteModelVariant::CharacterTeamMission(model) => model.write(writer)?,
            PalMapConcreteModelVariant::FarmSkillFruits(model) => model.write(writer)?,
            PalMapConcreteModelVariant::SupplyStorage(model) => model.write(writer)?,
            PalMapConcreteModelVariant::ItemBooth(model) => model.write(writer)?,
            PalMapConcreteModelVariant::EnergyStorage(model) => model.write(writer)?,
            PalMapConcreteModelVariant::DeathDroppedCharacter(model) => model.write(writer)?,
            PalMapConcreteModelVariant::ConvertItem(model) => model.write(writer)?,
            PalMapConcreteModelVariant::PickupItemOnLevel(model) => model.write(writer)?,
            PalMapConcreteModelVariant::DropItem(model) => model.write(writer)?,
            PalMapConcreteModelVariant::ItemDropOnDamag(model) => model.write(writer)?,
            PalMapConcreteModelVariant::DeathPenaltyStorage(model) => model.write(writer)?,
            PalMapConcreteModelVariant::DefenseBulletLauncher(model) => model.write(writer)?,
            PalMapConcreteModelVariant::GenerateEnergy(model) => model.write(writer)?,
            PalMapConcreteModelVariant::FarmBlockV2(model) => model.write(writer)?,
            PalMapConcreteModelVariant::FastTravelPoint(model) => model.write(writer)?,
            PalMapConcreteModelVariant::ShippingItem(model) => model.write(writer)?,
            PalMapConcreteModelVariant::ProductItem(model) => model.write(writer)?,
            PalMapConcreteModelVariant::RecoverOtomo(model) => model.write(writer)?,
            PalMapConcreteModelVariant::HatchingEgg(model) => model.write(writer)?,
            PalMapConcreteModelVariant::TreasureBox(model) => model.write(writer)?,
            PalMapConcreteModelVariant::BreedFarm(model) => model.write(writer)?,
            PalMapConcreteModelVariant::Signboard(model) => model.write(writer)?,
            PalMapConcreteModelVariant::Torch(model) => model.write(writer)?,
            PalMapConcreteModelVariant::PalEgg(model) => model.write(writer)?,
            PalMapConcreteModelVariant::BaseCampPoint(model) => model.write(writer)?,
            PalMapConcreteModelVariant::ItemChest(model) => model.write(writer)?,
            PalMapConcreteModelVariant::ItemChestAffectCorruption(model) => model.write(writer)?,
            PalMapConcreteModelVariant::Unknown(model) => model.write(writer)?,
        }
